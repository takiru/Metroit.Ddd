...
{
    /// <summary>
    /// ValueObject クラスに指定された場合、または ValueObject クラス内のプロパティに指定された場合に、値の最小長を検証する属性です。
    /// </summary>
    ...
    public class VOMinLengthAttribute : MinLengthAttribute
    {
        /// <summary>
        /// 新しいインスタンスを生成します。
        /// </summary>
        /// <param name="length">許容される最小長。</param>
        public VOMinLengthAttribute(int length) : base(length)
        {
